...
def classify_message_with_gpt(message, api_key):
    ...
    prompt= '''fHãy phân tích nội dung tin nhắn sau và chọn 1 chủ đề phù hợp nhất từ danh sách mapping (1-36), 
...
api_key = 'sk-sk-1234efghqrstuvwx1234efghqrstuvwx1234efgh'
