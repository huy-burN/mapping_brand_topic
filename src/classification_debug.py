...
def classify_message_with_gemini(message, api_key):
    ...
    prompt = f""" Trả về 0 hoặc 1 và lời giải thích
     Định dạng phản hồi:
    {{"classification": 1 hoặc 0, "explanation": "Giải thích về phân loại."}}
...
calculateaccu(excel_path, output_path, api_key, num_messages=40, max_workers=10)
